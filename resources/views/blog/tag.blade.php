...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <div class="text-center mb-12">
        ...
        <div class="mt-6">
            <span class="inline-flex items-center text-gray-500">
                ...
                {{ $posts->total() }} {{ Str::plural('article', $posts->total()) }} tagged with "{{ $tag->name }}"
            </span>
        </div>
    </div>
            ...
            <div class="p-6">
                ...
                <div class="flex flex-wrap gap-2">
                    ...
                    <a href="{{ route('blog.tag', $postTag->slug) }}" 
                       class="badge text-xs hover:opacity-80 transition-opacity {{ $postTag->id === $tag->id ? 'ring-2 ring-white ring-opacity-50' : '' }}" 
    ...
    <div class="text-center py-16">
        ...
        <h3 class="text-2xl font-semibold text-gray-800 mb-2">No articles with this tag yet</h3>
